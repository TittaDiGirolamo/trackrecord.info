...
- **Material differences from draft to final:** Grok initially suggested outcome = 1.0. User verified via FIFA sources. Outcome confirmed with no change. Minor edits for clarity.
