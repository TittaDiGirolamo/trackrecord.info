...
**Statement ID:** `pred-2026-05-21-crebolder-nl-groupf`  
...
> Netherlands qualifies from Group F for the knockout stage of the 2026 FIFA World Cup.
...
- **Material differences from draft to final:** Grok initially suggested outcome = 1.0. User verified via FIFA sources. Outcome confirmed with no change. Minor wording refinements for clarity.

## Final decision

- **outcome:** `1.0`
- **outcome_proof:** Netherlands finished first in Group F with 7 points (2 wins, 1 draw) and advanced to the knockout stage, per official FIFA group stage results published 2026-06-26.
- **outcome_verification_url:** https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026/teams/netherlands/fixtures
